...
/// <summary>
/// Custom Inspector for DocumentData.
/// Embeds an interactive 3D preview of the documentPrefab directly in the Inspector.
...
public class DocumentDataEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        var doc = (DocumentData)target;

        if (doc.documentPrefab == null)
        {
            CleanupPreview();
        ...
        if (_currentPrefab != doc.documentPrefab)
            BuildPreview(doc.documentPrefab);
    ...
    private void BuildPreview(GameObject prefab)
    {
        ...
        _previewPivot          = new GameObject("DocumentPreviewPivot");
