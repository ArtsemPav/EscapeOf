...
// NeonLampLitInput.hlsl — full replacement for URP LitInput.hlsl with
// _EmissionIntensity added inside UnityPerMaterial cbuffer for SRP Batcher
// / GPU Resident Drawer compatibility.
...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float , _EmissionIntensity)
...
static float  unity_DOTS_Sampled_EmissionIntensity;
...
void SetupDOTSLitMaterialPropertyCaches()
{
    ...
    unity_DOTS_Sampled_EmissionIntensity    = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _EmissionIntensity);
}
...
#define _EmissionIntensity      unity_DOTS_Sampled_EmissionIntensity
